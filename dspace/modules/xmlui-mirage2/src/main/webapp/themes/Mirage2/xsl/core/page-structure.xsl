        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>images/ico.ico</xsl:text>
                </xsl:attribute>
            </link>
            ...
            <title>
                <xsl:choose>
                    <xsl:when test="starts-with($request-uri, 'page/about')">
                        <xsl:text>UTN - RIA - </xsl:text><i18n:text>xmlui.mirage2.page-structure.aboutThisRepository</i18n:text>
                    </xsl:when>
                    <xsl:when test="not($page_title)">
                        <xsl:text> UTN - RIA - </xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:text>UTN - RIA - </xsl:text><xsl:copy-of select="$page_title/node()" />
                    </xsl:otherwise>
                </xsl:choose>
            </title>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-4 hidden-print">
                        <div class="pull-right">
                            <a title="@mire NV" target="_blank" href="http://www.utn.edu.ar/secretarias/tic/default.utn">
                                <img alt="@mire NV" src="{concat($theme-path, '/images/TIC.svg')}"/>
                            </a>
                        </div>
